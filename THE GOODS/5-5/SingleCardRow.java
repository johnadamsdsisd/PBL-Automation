...
public class SingleCardRow extends JPanel {
   ...
   private JTextArea cardTitle, cardTime;
   ...
   public void setData(Card current) {
      ...
      Color color = Color.decode(current.getColor().replace("#f3f72a", "#ffd000"));
      cardTitle.setForeground(color);
      cardTime.setForeground(color);
   }
