...
public class Intro extends JFrame implements ComponentListener {
   ...
   private JTextArea textField, textField1, textField2, textField3, textField4, textField5, textField6;
   private int wrong = 0;
   ...
   private void intro() { 
     if (ask) {
         ...
         textField5.setLocation((int)(width/2.6), (int)(height/1.6));
         textField5.setSize((int)(width/12), (int)(height/40));
         textField5.setEditable(false);
         textField6 = new JTextArea();
         textField6.setText("Click Here To Start ->");
         textField6.setFont(new Font("TimesRoman", Font.BOLD, (int)(height/50)));
         textField6.setForeground(Color.RED);
         textField6.setBackground(Color.YELLOW);
         textField6.setLocation((int)(width/3.6), (int)(height/1.4));
         textField6.setSize((int)(width/4), (int)(height/40));
