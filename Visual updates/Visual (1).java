...
public class Visual extends JFrame implements MouseListener, KeyListener, ComponentListener {
   ...
   private JPanel calContainer;
   private CardVisual cardContainer;
   private JLabel cardInstr;
   private JMenuBar menuBar;
   private JButton r, g, b, y, p, bl, nextCard, button1, b1, b2, hack, startStop, prev, next;
   ...
   public void componentResized(ComponentEvent e) {
      ...
      //System.out.println("Default size: .56 current size: " + String.valueOf((h / w)).substring(1, 5));
      
      //if (".562".equals(String.valueOf((h / w)).substring(1, 5)));
         changeSize();
   ...
   public void music() {
      ...
      panel3.setLocation((int)(width/2.9538),(int)(height/1.161));
      ...
      volume.setBounds((int)(width/2.06),(int)(height/1.12),(int)(width/4.8),(int)(height/21.6));
      ...
      disableAdsItem.addActionListener(
         new ActionListener()
         {
            public void actionPerformed(ActionEvent e)
            {
               ...
               { 
                  try{
                     AudioInputStream audioInputStream1 = AudioSystem.getAudioInputStream(new File("Music2.wav"));
