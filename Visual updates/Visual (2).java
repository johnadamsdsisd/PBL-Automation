...
public class Visual extends JFrame implements MouseListener, KeyListener {
   ...
   public Visual() {
    ...
    // File Menu, F - Mnemonic
      ...
      fileMenu1.setMnemonic(KeyEvent.VK_O);
      fileMenu.setMnemonic(KeyEvent.VK_F);
      menuBar.add(fileMenu);
      menuBar.add(fileMenu1);
      
      JMenuItem newMenuItem3 = new JMenuItem("Disable Ads", KeyEvent.VK_D);
      fileMenu1.add(newMenuItem3);
      
      newMenuItem3.addActionListener(
         new ActionListener()
         {
      ...
      JMenuItem newMenuItem4 = new JMenuItem("Enable Ads", KeyEvent.VK_E);
      fileMenu1.add(newMenuItem4);
      
      newMenuItem4.addActionListener(
         new ActionListener()
         {
            public void actionPerformed(ActionEvent e)
            {
      ...
      JMenuItem newMenuItem5 = new JMenuItem("Disable Music", KeyEvent.VK_D);
      fileMenu1.add(newMenuItem5);
      
      newMenuItem5.addActionListener(
         new ActionListener()
         {
            public void actionPerformed(ActionEvent e)
            {
      ...
      JMenuItem newMenuItem6 = new JMenuItem("Enable Music", KeyEvent.VK_E);
      fileMenu1.add(newMenuItem6);
      
      newMenuItem6.addActionListener(
         new ActionListener()
         {
            public void actionPerformed(ActionEvent e)
            {
