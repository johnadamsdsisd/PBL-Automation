...
public class Visual extends JFrame implements MouseListener, KeyListener, ComponentListener {
   ...
   private double height = (int) screenSize.getHeight(), width = (int) screenSize.getWidth(),areaX1, areaY1, areaX2, areaY2;
   private Font title = new Font("Serif", Font.BOLD, (int)(height/27));
   ...
   areaX1 = (int)(width/1.504);
   areaY1 = (int)(height/15.6);
   areaX2 = (int)(width/1.0868);
   areaY2 = (int)(height/1.9);
   
   if(((me.getXOnScreen() >= areaX1 && me.getXOnScreen() <= areaX2) && (me.getYOnScreen() >= areaY1 && me.getYOnScreen() <= areaY2))) {
         highLight++;
   ...
   private void changeSize() {
      ...
      prev.setFont(new Font("Rockwell", Font.BOLD, (int)(height/80)));
   ...
   private void calendar() {      
      ...
      next = new JButton(">");
      next.setBounds((int) ((width/1.9) - (width / 32)), 0, (int) (width / 32), (int) (height / 53));
      next.setFont(new Font("Rockwell", Font.BOLD, (int)(height/80)));
