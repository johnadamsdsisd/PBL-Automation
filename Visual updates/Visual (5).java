...
public class Visual extends JFrame implements MouseListener, KeyListener, ComponentListener {
   ...
   private JPanel calContainer, panel4, mainMenu;
   ...
   private JButton r, g, b, y, p, bl, nextCard, button1, b1, b2, hack, startStop, prev, next, X, login;
